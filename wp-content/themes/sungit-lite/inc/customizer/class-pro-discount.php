		...
		$manager->add_section(
			new Sungit_Lite_Discount_Customize_Section_Pro(
				...
				array(
					...
					'pro_text' =>__(" Get Sungit Premium Theme", "sungit-lite"),
					'pro_subtext' =>__("We've launched 'Sungit Premium Theme'. Buy today and save $10", "sungit-lite"),
					'pro_url'  => esc_url('https://yudleethemes.com/product/sungit-premium-theme/'),
					'priority' => 1,
				)
			)
		);
